...
(function () {
    ...
    function CreateDashboardController($location, $modalInstance, dashboardData, $cookies, DashboardType) {
        ...
        ctrl.templates = [
            {value: 'capone', name: 'Team', type: DashboardType.TEAM},
            {value: 'caponechatops', name: 'ChatOps', type: DashboardType.TEAM},
            {value: 'product-dashboard', name: 'Group Dashboard', type: DashboardType.PRODUCT}
        ];
